...
public static class EditorHelper{
	...
	public static string EDITOR_NEDITOR_PATH{
		get{
			return EDITOR_ROOT_PATH+"/NEDITOR";
		}
	} 
	...
	/// 物体编辑器目录地址
	/// </summary>
	/// <value>The UR l_ GAMEOBJEC t_ EDITO.</value>
	public static string EDITOR_GAMEOBJECT_PATH{
		get{
			return EDITOR_NEDITOR_PATH+"/GameObjectEditor";
		}
	} 
	...
	/// 角色编辑器目录地址
	/// </summary>
	/// <value>The UR l_ ROL e_ EDITO.</value>
	public static string EDITOR_ROLE_PATH{
		get{
			return EDITOR_NEDITOR_PATH+"/RoleEditor";
		}
	}
	...
	public static string EDITOR_SCENE_PATH{
		get{
			return EDITOR_NEDITOR_PATH+"/SceneEditor";
		}
	}
	...
	public static string EDITOR_TABLE_PATH{
		get{
			return EDITOR_NEDITOR_PATH+"/TableEditor";
		}
	}
